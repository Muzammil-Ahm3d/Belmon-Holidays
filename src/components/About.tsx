      ...
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          >
            ...
            {/* Floating Card */}
            <div className="relative mt-4 md:mt-0 md:absolute md:-bottom-6 md:-right-6 bg-card p-4 md:p-6 rounded-xl shadow-elegant border-2 border-primary/20 z-10 w-fit ml-auto md:ml-0">
              <p className="text-3xl md:text-4xl font-serif font-bold text-primary">20+</p>
